...
meta_file <- '/fh/fast/cheung_k/Ami/NewNecrosisRNAseq/crossmap_controls_metadata.csv'
save_dir <- '/fh/fast/cheung_k/Ami/NewNecrosisRNAseq/feature_counts/'
save_prefix <- 'crossmap_trimmed'
